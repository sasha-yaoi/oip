...
discharge_plot_line, = axes.plot(discharge_data[0], discharge_data[1], color = 'pink')
...
axes.grid(color = "green", which = "minor", linestyle = ':', linewidth = 0.5)
...
axes.text(x = (charge_time/2-0.8), y = volt_max/2, s = ("Charge time: " + str(round(charge_time, 2)) + " s"), color = 'pink', fontsize = 14)
